...
CLASSES_DET = ('BJT', 'Diode', 'MOSFET', 'OP_AMP', 'Resistor', 'cable', 'capacitor', 'variable_resistor')
...
# obb model classes
CLASSES_OBB = ('plane', 'ship', 'storage tank', 'baseball diamond',
               'tennis court', 'basketball court', 'ground track field',
               'harbor', 'bridge', 'large vehicle', 'small vehicle',
               'helicopter', 'roundabout', 'soccer ball field',
               'swimming pool')

# colors for obb classes
COLORS_OBB = {
    cls: [random.randint(0, 255) for _ in range(3)]
    for i, cls in enumerate(CLASSES_OBB)
}
