...
class Detector:
    ...
    def obj_pixel(self, cap, window_name, n_frames=5):
        for _ in range(3):
        ...
        if len(smoothed) == 0:
            ...
            cls = first_obj['class']
            #if cls == 'Resistor':
            #    cls = '10kOhm' #resistor color-band recognition
            #if abs(first_obj['bbox'][2]-first_obj['bbox'][0])>abs(first_obj['bbox'][3]-first_obj['bbox'][1]):
            #    grip_rot = True
            #else:
            #    grip_rot = False
